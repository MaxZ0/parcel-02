...
$bg-nav: #F4F3ED !default;
$bg-my-own-gray: #E5E5E5 !default;
$white: #fff !default;
...
$colors: map-merge(("blue": $blue,
    ...
    "gray": $gray-600,
    "gray-dark": $gray-800,
    "bg-my-own-gray": $bg-my-own-gray),
  $colors);

$bg-my-own-gray: $bg-my-own-gray !default;
...
$navbar-light-active-color: rgba($red, .9) !default;
